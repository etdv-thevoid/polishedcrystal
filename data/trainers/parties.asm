...
BugsyGroup:
	...
	dbp 14, BUTTERFREE, MALE
		db NO_ITEM, 32, ABILITY_1 | NAT_NEUTRAL
...
WhitneyGroup:
	...
	dbp 19, CLEFAIRY, FEMALE
		db NO_ITEM, 48, ABILITY_1 | NAT_NEUTRAL
	...
	dbp 21, MILTANK, FEMALE
		db LUM_BERRY, 48, ABIL_MILTANK_SCRAPPY | NAT_NEUTRAL
...
MortyGroup:
	...
	; party
	dbp 24, HAUNTER, MALE
		db NO_ITEM, 64, ABIL_HAUNTER_LEVITATE | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	...
	dbp 24, NOCTOWL, MALE
		db NO_ITEM, 64, ABILITY_1 | NAT_NEUTRAL
...
endc
	...
	dbp 26, GENGAR, MALE
if DEF(FAITHFUL)
		db WIDE_LENS, 64, ABIL_GENGAR_CURSED_BODY | NAT_NEUTRAL
else
		db WIDE_LENS, 64, ABIL_GENGAR_LEVITATE | NAT_NEUTRAL
endc
...
ClairGroup:
	...
	dbp 43, GYARADOS, FEMALE
		db NO_ITEM, 128, ABILITY_1 | NAT_NEUTRAL
		db CRUNCH, THRASH, DRAGON_PULSE, AQUA_TAIL
if DEF(FAITHFUL)
	dbp 45, DRAGONAIR, FEMALE
		db NO_ITEM, 128, ABILITY_1 | NAT_NEUTRAL
		db THUNDER_WAVE, EXTREMESPEED, DRAGON_PULSE, ICE_BEAM
else
...
if DEF(FAITHFUL)
	dbp 44, DRAGONAIR, FEMALE
		db NO_ITEM, 128, ABILITY_1 | NAT_NEUTRAL
		db THUNDER_WAVE, EXTREMESPEED, DRAGON_PULSE, THUNDERBOLT
else
...
endc
	dbp 44, DRAGONAIR, FEMALE
		db NO_ITEM, 128, ABILITY_1 | NAT_NEUTRAL
		db THUNDER_WAVE, EXTREMESPEED, DRAGON_PULSE, FLAMETHROWER
	dbp 47, KINGDRA, FEMALE
		db SHELL_BELL, 128, ABIL_KINGDRA_SNIPER | NAT_NEUTRAL
	...
	dbp 74, EXEGGUTOR, FEMALE
		db LUM_BERRY, ABIL_EXEGGUTOR_HARVEST | NAT_NEUTRAL
		db REST, SLEEP_POWDER, GIGA_DRAIN, DRAGON_PULSE
if DEF(FAITHFUL)
	dbp 73, DRAGONAIR, FEMALE
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL
		db DRAGON_DANCE, EXTREMESPEED, OUTRAGE, SURF
else
	dbp 73, YANMEGA, FEMALE
		db LEFTOVERS, ABILITY_1 | NAT_NEUTRAL
...
if DEF(FAITHFUL)
	dbp 73, DRAGONAIR, FEMALE
		...
		db DRAGON_DANCE, EXTREMESPEED, OUTRAGE, THUNDERBOLT
else
	dbp 73, AMPHAROS, FEMALE
		db DRAGON_FANG, ABILITY_1 | NAT_NEUTRAL
		db THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
	dbp 74, DRAGONITE, FEMALE
		db LIFE_ORB, ABILITY_1 | NAT_NEUTRAL
		db DRAGON_DANCE, EARTHQUAKE, OUTRAGE, FIRE_BLAST
...
ChampionGroup:
	...
	dbp 57, GYARADOS, MALE
		db MUSCLE_BAND, 208, ABIL_GYARADOS_INTIMIDATE | NAT_SPD_UP_SATK_DOWN
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	dbp 58, DRAGONITE, MALE
		db WIDE_LENS, 208, ABIL_DRAGONITE_INNER_FOCUS | NAT_SATK_UP_ATK_DOWN
		db FIRE_BLAST, BLIZZARD, THUNDER, HYPER_BEAM
	dbp 58, KINGDRA, MALE
		db SCOPE_LENS, 208, ABIL_KINGDRA_SNIPER | NAT_SATK_UP_ATK_DOWN
		db FOCUS_ENERGY, DRAGON_PULSE, SURF, HYPER_BEAM
	dbp 57, AERODACTYL, MALE
		db KINGS_ROCK, 208, ABIL_AERODACTYL_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
		db AERIAL_ACE, ANCIENTPOWER, ROCK_SLIDE, GIGA_IMPACT
	dbp 57, CHARIZARD, MALE
		db WISE_GLASSES, 208, ABIL_CHARIZARD_SOLAR_POWER | NAT_SATK_UP_ATK_DOWN
if DEF(FAITHFUL)
...
endc
	dbp 60, DRAGONITE, MALE
		db LEFTOVERS, 208, SHINY_MASK | ABIL_DRAGONITE_MULTISCALE | NAT_ATK_UP_SATK_DOWN
	...
	dbp 75, GYARADOS, MALE
		db LIFE_ORB, ABILITY_1 | NAT_SPD_UP_SATK_DOWN
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	dbp 77, DRAGONITE, MALE
		db LEFTOVERS, ABIL_DRAGONITE_INNER_FOCUS | NAT_SATK_UP_ATK_DOWN
...
if DEF(FAITHFUL)
	dbp 75, CHARIZARD, MALE
		db LIFE_ORB, ABIL_CHARIZARD_DROUGHT | NAT_SATK_UP_ATK_DOWN
		db FIRE_BLAST, SOLAR_BEAM, FOCUS_BLAST, AIR_SLASH
else
	dbp 75, CHARIZARD, MALE
		db LIFE_ORB, ABIL_CHARIZARD_TOUGH_CLAWS | NAT_ATK_UP_SATK_DOWN
...
RedGroup:
	...
	dbp 90, PIKACHU, MALE | PIKACHU_RED_FORM
		db LIGHT_BALL, ABIL_PIKACHU_STATIC | NAT_SPD_UP_SDEF_DOWN
...
LeafGroup:
	...
	dbp 100, VENUSAUR, FEMALE
		db MIRACLE_SEED, FAKE_PERFECT_DVS, ABIL_VENUSAUR_THICK_FAT | NAT_SPD_UP_DEF_DOWN
...
endc
	...
	; party
	dbp 60, EEVEE, FEMALE
		db EVIOLITE, ABILITY_1 | NAT_SPD_UP_DEF_DOWN, "VuiVui@"
...
CooltrainerMGroup:
	...
	; party
	dbp 8, GEODUDE, MALE
		db AIR_BALLOON, 12, $DD, $DD, $DD, ABIL_GEODUDE_STURDY | NAT_DEF_UP_SPD_DOWN
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 11, BELLSPROUT, MALE
		db MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_BELLSPROUT_CHLOROPHYLL | NAT_ATK_UP_SATK_DOWN
		db VINE_WHIP, GROWTH, WRAP, SLEEP_POWDER
	dbp 11, ZUBAT, MALE
		db MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_ZUBAT_INNER_FOCUS | NAT_SATK_UP_SDEF_DOWN
		db GUST, ABSORB, ASTONISH, BITE
	dbp 14, BULBASAUR, MALE
		db MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_BULBASAUR_CHLOROPHYLL | NAT_SPD_UP_DEF_DOWN
...
endc
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 20, WEEPINBELL, FEMALE
		db BINDING_BAND, 52, ABIL_WEEPINBELL_CHLOROPHYLL | NAT_SPD_UP_DEF_DOWN
		db WRAP, SLEEP_POWDER, POISONPOWDER, STUN_SPORE
	dbp 20, AZUMARILL, FEMALE
		db BINDING_BAND, 52, ABIL_AZUMARILL_SAP_SIPPER | NAT_SPD_UP_DEF_DOWN
		db WHIRLPOOL, PERISH_SONG, AQUA_TAIL, PROTECT
	dbp 21, CHARMELEON, FEMALE
		db BINDING_BAND, 52, ABIL_CHARMELEON_SOLAR_POWER | NAT_SPD_UP_DEF_DOWN
...
endc
	...
	dbp 35, PUPITAR, MALE
if DEF(FAITHFUL)
		db ROCKY_HELMET, 116, ABIL_PUPITAR_SHED_SKIN | NAT_ATK_UP_SATK_DOWN
else
		db ROCKY_HELMET, 116, ABIL_PUPITAR_BATTLE_ARMOR | NAT_ATK_UP_SATK_DOWN
endc
		db SANDSTORM, ROCK_SLIDE, PURSUIT, OUTRAGE
	dbp 36, FORRETRESS, MALE
		db ROCKY_HELMET, 116, ABIL_FORRETRESS_STURDY | NAT_ATK_UP_SATK_DOWN
		db SPIKES, EXPLOSION, SANDSTORM, DIG
	dbp 36, SKARMORY, MALE
		db ROCKY_HELMET, 116, ABIL_SKARMORY_STURDY | NAT_NEUTRAL
		db SPIKES, ROAR, TOXIC, PROTECT
	dbp 37, UMBREON, MALE
		db ROCKY_HELMET, 116, ABIL_UMBREON_SYNCHRONIZE | NAT_NEUTRAL
...
VeteranFGroup:
	...
	dbp 49, ALAKAZAM, FEMALE
		db CHOICE_SPECS, 148, DVS_HP_FIRE, ABIL_ALAKAZAM_TRACE | NAT_SATK_UP_ATK_DOWN
		db PSYCHIC_M, SHADOW_BALL, FOCUS_BLAST, HIDDEN_POWER
	dbp 49, PORYGON_Z, FEMALE
		db CHOICE_SPECS, 148, DVS_HP_GROUND, ABIL_PORYGON_Z_ADAPTABILITY | NAT_SATK_UP_ATK_DOWN
		db TRI_ATTACK, DARK_PULSE, ICE_BEAM, HIDDEN_POWER
	dbp 49, GENGAR, FEMALE
if DEF(FAITHFUL)
		db CHOICE_SPECS, 148, DVS_HP_ICE, ABIL_GENGAR_CURSED_BODY | NAT_SATK_UP_ATK_DOWN
else
		db CHOICE_SPECS, 148, DVS_HP_ICE, ABIL_GENGAR_LEVITATE | NAT_SATK_UP_ATK_DOWN
endc
...
GiovanniGroup:
	...
	dbp 70, MEWTWO, MALE | MEWTWO_ARMORED_FORM
		db ARMOR_SUIT, ABIL_MEWTWO_ARMORED_BATTLE_ARMOR | NAT_SATK_UP_ATK_DOWN, "?????@"
	...
	dbp 64, NIDOKING, MALE
		db LIFE_ORB, ABIL_NIDOKING_SHEER_FORCE | NAT_SPD_UP_ATK_DOWN
		db SLUDGE_BOMB, EARTH_POWER, ICE_BEAM, FLAMETHROWER
	dbp 62, DUGTRIO, MALE
		db CHOICE_BAND, ABIL_DUGTRIO_ARENA_TRAP | NAT_SPD_UP_SATK_DOWN
...
if !DEF(FAITHFUL)
		db LUM_BERRY, ABIL_KANGASKHAN_PARENTAL_BOND | NAT_SPD_UP_SATK_DOWN
...
endc
	...
	dbp 64, NIDOQUEEN, FEMALE
		db LIFE_ORB, ABIL_NIDOQUEEN_SHEER_FORCE | NAT_SPD_UP_DEF_DOWN
...
if !DEF(FAITHFUL)
		db LIFE_ORB, ABIL_CHARIZARD_TOUGH_CLAWS | NAT_SPD_UP_SATK_DOWN
else
		db LIFE_ORB, ABIL_CHARIZARD_DROUGHT | NAT_SPD_UP_SATK_DOWN
endc
	...
	dbp 82, NIDOKING, MALE
		db LIFE_ORB, ABIL_NIDOKING_SHEER_FORCE | NAT_SPD_UP_SATK_DOWN
...
YellowGroup:
	...
	dbp 74, DODRIO, FEMALE
		db SHARP_BEAK, ABIL_DODUO_TANGLED_FEET | NAT_SPD_UP_DEF_DOWN, "Dody@"
	...
	dbp 75, PIKACHU, FEMALE | PIKACHU_YELLOW_FORM
		db LIGHT_BALL, ABIL_PIKACHU_STATIC | NAT_SPD_UP_DEF_DOWN, "Chuchu@"
