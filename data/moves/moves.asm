...
if DEF(FAITHFUL)
	...
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         60, FLYING,    100, 30,   0, PHYSICAL
endc
...
if DEF(FAITHFUL)
	...
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING,   80,  5,  30, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move THUNDERBOLT,  EFFECT_PARALYZE_HIT,       90, ELECTRIC,  100, 10,  10, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move AQUA_TAIL,    EFFECT_NORMAL_HIT,         90, WATER,      90, 15,   0, PHYSICAL
endc
...
if DEF(FAITHFUL)
	...
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,       80,  5,  30, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, GHOST,     100, 15,   0, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move DRAIN_KISS,   EFFECT_LEECH_HIT,          60, FAIRY,     100, 15,   0, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        100, WATER,      80,  5,   0, PHYSICAL
endc
...
if DEF(FAITHFUL)
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON,    100, 10,  10, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      120, ELECTRIC,   50, 10, 100, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       120, FIGHTING,   50, 10, 100, PHYSICAL
endc
...
if DEF(FAITHFUL)
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,   90, STEEL,      90, 10,  10, PHYSICAL
endc
...
if DEF(FAITHFUL)
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      200, PSYCHIC,   100, 10,   0, SPECIAL
...
if DEF(FAITHFUL)
	...
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,   120, FAIRY,      80,  5,  30, SPECIAL
endc
